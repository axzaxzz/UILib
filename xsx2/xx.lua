...
local library = {
    ...
    -- GUI element storage for theme updates
    _guiElements = {},
    _textElements = {},
    _backgroundOverlay = nil,
    ...
    theme = {
        ...
        backgroundLight = Color3.fromRGB(34, 34, 34),
        
        -- Edge/Border colors
        edge = Color3.fromRGB(60, 60, 60),
        edgeDark = Color3.fromRGB(50, 50, 50),
        
        -- Accent colors (main theme color)
        accent = Color3.fromRGB(159, 115, 255),
        accentDark = Color3.fromRGB(106, 69, 181),
        
        -- Text colors
        textPrimary = Color3.fromRGB(198, 198, 198),
        textSecondary = Color3.fromRGB(190, 190, 190),
        textDimmed = Color3.fromRGB(170, 170, 170),
        textBright = Color3.fromRGB(210, 210, 210),
        textDark = Color3.fromRGB(124, 124, 124),
        
        -- Component colors
        buttonIdle = Color3.fromRGB(50, 50, 50),
...
function library:RefreshTheme()
    -- Update all stored GUI elements with new theme colors
    for _, element in pairs(library._guiElements) do
        if element.obj and element.obj.Parent then
            pcall(function()
                if element.type == "background" then
                    element.obj.BackgroundColor3 = library.theme.edge
                elseif element.type == "backgroundGradient" then
                    element.obj.Color = ColorSequence.new{
                        ColorSequenceKeypoint.new(0.00, library.theme.backgroundLight),
                        ColorSequenceKeypoint.new(1.00, library.theme.backgroundDark)
                    }
                elseif element.type == "bar" or element.type == "accent" then
                    element.obj.BackgroundColor3 = library.theme.accent
                elseif element.type == "text" then
                    if element.variant == "primary" then
                        element.obj.TextColor3 = library.theme.textPrimary
                    elseif element.variant == "secondary" then
                        element.obj.TextColor3 = library.theme.textSecondary
                    elseif element.variant == "dimmed" then
                        element.obj.TextColor3 = library.theme.textDimmed
                    elseif element.variant == "dark" then
                        element.obj.TextColor3 = library.theme.textDark
                    end
                elseif element.type == "button" then
                    element.obj.BackgroundColor3 = library.theme.buttonIdle
                elseif element.type == "edgeDark" then
                    element.obj.BackgroundColor3 = library.theme.edgeDark
                elseif element.type == "scrollbar" then
                    element.obj.ScrollBarImageColor3 = library.theme.scrollbar
                elseif element.type == "accentImage" then
                    element.obj.ImageColor3 = library.theme.accent
                elseif element.type == "toggleGradient" then
                    element.obj.Color = ColorSequence.new{
                        ColorSequenceKeypoint.new(0.00, library.theme.accent),
                        ColorSequenceKeypoint.new(1.00, library.theme.accentDark)
                    }
                end
            end)
        end
...
function library:TrackElement(obj, elemType, variant)
    table.insert(library._guiElements, {
        obj = obj,
        type = elemType,
        variant = variant
    })
...
function library:TrackText(obj)
    table.insert(library._textElements, obj)
end

function library:SetFont(font)
    library.currentFont = font
    for _, textObj in pairs(library._textElements) do
...
function library:SaveTheme()
    local themeString = "{"
    themeString = themeString .. "accent=Color3.fromRGB(" .. math.floor(library.theme.accent.R*255) .. "," .. math.floor(library.theme.accent.G*255) .. "," .. math.floor(library.theme.accent.B*255) .. "),"
    themeString = themeString .. "accentDark=Color3.fromRGB(" .. math.floor(library.theme.accentDark.R*255) .. "," .. math.floor(library.theme.accentDark.G*255) .. "," .. math.floor(library.theme.accentDark.B*255) .. "),"
    themeString = themeString .. "backgroundDark=Color3.fromRGB(" .. math.floor(library.theme.backgroundDark.R*255) .. "," .. math.floor(library.theme.backgroundDark.G*255) .. "," .. math.floor(library.theme.backgroundDark.B*255) .. "),"
    themeString = themeString .. "backgroundLight=Color3.fromRGB(" .. math.floor(library.theme.backgroundLight.R*255) .. "," .. math.floor(library.theme.backgroundLight.G*255) .. "," .. math.floor(library.theme.backgroundLight.B*255) .. "),"
    themeString = themeString .. "edge=Color3.fromRGB(" .. math.floor(library.theme.edge.R*255) .. "," .. math.floor(library.theme.edge.G*255) .. "," .. math.floor(library.theme.edge.B*255) .. "),"
    themeString = themeString .. "edgeDark=Color3.fromRGB(" .. math.floor(library.theme.edgeDark.R*255) .. "," .. math.floor(library.theme.edgeDark.G*255) .. "," .. math.floor(library.theme.edgeDark.B*255) .. "),"
    themeString = themeString .. "textPrimary=Color3.fromRGB(" .. math.floor(library.theme.textPrimary.R*255) .. "," .. math.floor(library.theme.textPrimary.G*255) .. "," .. math.floor(library.theme.textPrimary.B*255) .. "),"
    themeString = themeString .. "textSecondary=Color3.fromRGB(" .. math.floor(library.theme.textSecondary.R*255) .. "," .. math.floor(library.theme.textSecondary.G*255) .. "," .. math.floor(library.theme.textSecondary.B*255) .. "),"
    themeString = themeString .. "textDimmed=Color3.fromRGB(" .. math.floor(library.theme.textDimmed.R*255) .. "," .. math.floor(library.theme.textDimmed.G*255) .. "," .. math.floor(library.theme.textDimmed.B*255) .. "),"
    themeString = themeString .. "textBright=Color3.fromRGB(" .. math.floor(library.theme.textBright.R*255) .. "," .. math.floor(library.theme.textBright.G*255) .. "," .. math.floor(library.theme.textBright.B*255) .. "),"
    themeString = themeString .. "scrollbar=Color3.fromRGB(" .. math.floor(library.theme.scrollbar.R*255) .. "," .. math.floor(library.theme.scrollbar.G*255) .. "," .. math.floor(library.theme.scrollbar.B*255) .. "),"
    themeString = themeString .. "buttonIdle=Color3.fromRGB(" .. math.floor(library.theme.buttonIdle.R*255) .. "," .. math.floor(library.theme.buttonIdle.G*255) .. "," .. math.floor(library.theme.buttonIdle.B*255) .. "),"
    themeString = themeString .. "buttonHover=Color3.fromRGB(" .. math.floor(library.theme.buttonHover.R*255) .. "," .. math.floor(library.theme.buttonHover.G*255) .. "," .. math.floor(library.theme.buttonHover.B*255) .. ")}"
    return themeString
end

function library:LoadTheme(themeString)
    local success, themeTable = pcall(function()
        return loadstring("return " .. themeString)()
    end)
    if success and type(themeTable) == "table" then
...
function library:GetWorkspaceFolder()
    -- Just return empty string - files will be saved in executor root
    -- This works for ALL executors without needing special detection
    return ""
end

function library:GetFullPath(fileName, extension)
    local workspace = library:GetWorkspaceFolder()
    if workspace ~= "" then
        return workspace .. "/" .. fileName .. extension
    end
    return fileName .. extension
end

function library:SaveThemeToFile(fileName)
    local themeData = game:GetService("HttpService"):JSONEncode({
        accent = {math.floor(library.theme.accent.R*255), math.floor(library.theme.accent.G*255), math.floor(library.theme.accent.B*255)},
        accentDark = {math.floor(library.theme.accentDark.R*255), math.floor(library.theme.accentDark.G*255), math.floor(library.theme.accentDark.B*255)},
        backgroundDark = {math.floor(library.theme.backgroundDark.R*255), math.floor(library.theme.backgroundDark.G*255), math.floor(library.theme.backgroundDark.B*255)},
        backgroundLight = {math.floor(library.theme.backgroundLight.R*255), math.floor(library.theme.backgroundLight.G*255), math.floor(library.theme.backgroundLight.B*255)},
        edge = {math.floor(library.theme.edge.R*255), math.floor(library.theme.edge.G*255), math.floor(library.theme.edge.B*255)},
        edgeDark = {math.floor(library.theme.edgeDark.R*255), math.floor(library.theme.edgeDark.G*255), math.floor(library.theme.edgeDark.B*255)},
        textPrimary = {math.floor(library.theme.textPrimary.R*255), math.floor(library.theme.textPrimary.G*255), math.floor(library.theme.textPrimary.B*255)},
        textSecondary = {math.floor(library.theme.textSecondary.R*255), math.floor(library.theme.textSecondary.G*255), math.floor(library.theme.textSecondary.B*255)},
        textDimmed = {math.floor(library.theme.textDimmed.R*255), math.floor(library.theme.textDimmed.G*255), math.floor(library.theme.textDimmed.B*255)},
        textBright = {math.floor(library.theme.textBright.R*255), math.floor(library.theme.textBright.G*255), math.floor(library.theme.textBright.B*255)},
        scrollbar = {math.floor(library.theme.scrollbar.R*255), math.floor(library.theme.scrollbar.G*255), math.floor(library.theme.scrollbar.B*255)},
        buttonIdle = {math.floor(library.theme.buttonIdle.R*255), math.floor(library.theme.buttonIdle.G*255), math.floor(library.theme.buttonIdle.B*255)},
        buttonHover = {math.floor(library.theme.buttonHover.R*255), math.floor(library.theme.buttonHover.G*255), math.floor(library.theme.buttonHover.B*255)}
    })
    
    if writefile then
        local fullPath = library:GetFullPath(fileName, ".json")
        writefile(fullPath, themeData)
        return true
    end
    return false
end

function library:LoadThemeFromFile(fileName)
    local fullPath = library:GetFullPath(fileName, ".json")
    if readfile and isfile and isfile(fullPath) then
        ...
        if success and type(data) == "table" then
            library:SetTheme({
                accent = Color3.fromRGB(unpack(data.accent)),
                accentDark = Color3.fromRGB(unpack(data.accentDark)),
                backgroundDark = Color3.fromRGB(unpack(data.backgroundDark)),
                backgroundLight = Color3.fromRGB(unpack(data.backgroundLight)),
                edge = Color3.fromRGB(unpack(data.edge)),
                edgeDark = Color3.fromRGB(unpack(data.edgeDark)),
                textPrimary = Color3.fromRGB(unpack(data.textPrimary)),
                textSecondary = Color3.fromRGB(unpack(data.textSecondary)),
                textDimmed = Color3.fromRGB(unpack(data.textDimmed)),
                textBright = Color3.fromRGB(unpack(data.textBright)),
                scrollbar = Color3.fromRGB(unpack(data.scrollbar)),
                buttonIdle = Color3.fromRGB(unpack(data.buttonIdle)),
                buttonHover = Color3.fromRGB(unpack(data.buttonHover))
            })
            return true
        end
    end
...
function library:ListThemeFiles()
    local themes = {}
    if listfiles then
        ...
        if success and files then
            for _, file in pairs(files) do
                if type(file) == "string" and file:lower():match("%.json$") then
                    local name = file:match("([^/\\]+)%.json$")
                    if name and not name:match("^%.+") then  -- Skip hidden files
...
-- Complete config system for all settings
function library:SaveConfig(configName, configData)
    if writefile then
        local fullData = {
            theme = {
                accent = {math.floor(library.theme.accent.R*255), math.floor(library.theme.accent.G*255), math.floor(library.theme.accent.B*255)},
                ...
                buttonIdle = {math.floor(library.theme.buttonIdle.R*255), math.floor(library.theme.buttonIdle.G*255), math.floor(library.theme.buttonIdle.B*255)},
                buttonHover = {math.floor(library.theme.buttonHover.R*255), math.floor(library.theme.buttonHover.G*255), math.floor(library.theme.buttonHover.B*255)},
                font = tostring(library.currentFont)
            },
            settings = configData or {}
        }
        
        local encoded = game:GetService("HttpService"):JSONEncode(fullData)
        local fullPath = library:GetFullPath(configName, ".txt")
...
function library:LoadConfig(configName)
    ...
    if readfile and isfile and isfile(fullPath) then
        ...
        if success and type(data) == "table" then
            ...
            if data.theme then
                library:SetTheme({
                    accent = Color3.fromRGB(unpack(data.theme.accent)),
                    accentDark = Color3.fromRGB(unpack(data.theme.accentDark)),
                    backgroundDark = Color3.fromRGB(unpack(data.theme.backgroundDark)),
                    backgroundLight = Color3.fromRGB(unpack(data.theme.backgroundLight)),
                    edge = Color3.fromRGB(unpack(data.theme.edge)),
                    edgeDark = Color3.fromRGB(unpack(data.theme.edgeDark)),
                    textPrimary = Color3.fromRGB(unpack(data.theme.textPrimary)),
                    textSecondary = Color3.fromRGB(unpack(data.theme.textSecondary)),
                    textDimmed = Color3.fromRGB(unpack(data.theme.textDimmed)),
                    textBright = Color3.fromRGB(unpack(data.theme.textBright)),
                    scrollbar = Color3.fromRGB(unpack(data.theme.scrollbar)),
                    buttonIdle = Color3.fromRGB(unpack(data.theme.buttonIdle)),
                    buttonHover = Color3.fromRGB(unpack(data.theme.buttonHover))
                })
                
                -- Load font if available
                if data.theme.font then
                    local fontMap = {
                        ["Enum.Font.Code"] = Enum.Font.Code,
                        ["Enum.Font.SourceSans"] = Enum.Font.SourceSans,
                        ["Enum.Font.Gotham"] = Enum.Font.Gotham,
                        ["Enum.Font.GothamMedium"] = Enum.Font.GothamMedium,
                        ["Enum.Font.GothamBold"] = Enum.Font.GothamBold,
                        ["Enum.Font.Roboto"] = Enum.Font.Roboto,
                        ["Enum.Font.RobotoMono"] = Enum.Font.RobotoMono,
                        ["Enum.Font.Ubuntu"] = Enum.Font.Ubuntu,
                        ["Enum.Font.Arcade"] = Enum.Font.Arcade,
                        ["Enum.Font.Fantasy"] = Enum.Font.Fantasy,
                        ["Enum.Font.SciFi"] = Enum.Font.SciFi
                    }
                    local font = fontMap[data.theme.font]
                    if font then library:SetFont(font) end
                end
            end
...
function library:ListConfigFiles()
    ...
    if listfiles then
        ...
        if success and files then
            for _, file in pairs(files) do
                if type(file) == "string" and file:lower():match("%.txt$") then
...
library.overlaySettings = {
    primaryColor = Color3.fromRGB(100, 180, 255),
    secondaryColor = Color3.fromRGB(150, 200, 255),
    accentColor = Color3.fromRGB(255, 255, 255),
    backgroundColor = Color3.fromRGB(0, 5, 15),
    intensity = 1.0,
    currentStyle = "cyber",  -- Track current background style
    speed = 1.0  -- Speed multiplier
}

function library:CreateBackgroundOverlay()
    if library._backgroundOverlay then return end
    
    local overlay = Instance.new("ScreenGui")
    overlay.Name = "BackgroundOverlay"
    overlay.Parent = CoreGuiService
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = library.overlaySettings.backgroundColor
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Position = UDim2.new(0, 0, 0, 0)
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    
    -- Grid lines (horizontal)
    for i = 1, 20 do
        local line = Instance.new("Frame")
        line.Name = "GridLineH" .. i
        line.Parent = darkFrame
        line.BackgroundColor3 = library.overlaySettings.primaryColor
    ...
    -- Digital rain effect (like Matrix but customizable)
    local rainStreams = {}
    local rainCount = 25
    
    for i = 1, rainCount do
        local rain = Instance.new("TextLabel")
        rain.Name = "RainStream" .. i
        rain.Parent = darkFrame
        rain.BackgroundTransparency = 1
        rain.BorderSizePixel = 0
        rain.Font = Enum.Font.Code
        rain.TextSize = math.random(12, 20)
        rain.TextColor3 = library.overlaySettings.secondaryColor
        rain.TextTransparency = math.random(30, 70) / 100
        rain.Size = UDim2.new(0, 25, 0, 600)
        rain.Position = UDim2.new(math.random(0, 100) / 100, 0, -0.8, 0)
        rain.TextXAlignment = Enum.TextXAlignment.Center
        rain.TextYAlignment = Enum.TextYAlignment.Top
        rain.ClipsDescendants = false
        
        local chars = {">", "<", "/", "\\", "|", "-", "=", "+", "*", "#", "@", "$", "%", "&"}
        local rainText = ""
        for j = 1, 40 do
            rainText = rainText .. chars[math.random(1, #chars)] .. "\n"
        end
        rain.Text = rainText
        
        table.insert(rainStreams, {
            obj = rain,
            speed = math.random(3, 12) / 1000,
            resetY = math.random(-120, -60) / 100
        })
    end
    
    -- Binary code streams
    local binaryStreams = {}
    local streamCount = 40
    
    for i = 1, streamCount do
        local stream = Instance.new("TextLabel")
        stream.Name = "BinaryStream" .. i
        stream.Parent = darkFrame
        stream.BackgroundTransparency = 1
        stream.BorderSizePixel = 0
        stream.Font = Enum.Font.Code
        stream.TextSize = math.random(10, 16)
        stream.TextColor3 = library.overlaySettings.secondaryColor
        stream.TextTransparency = math.random(20, 60) / 100
        stream.Size = UDim2.new(0, 30, 0, 400)
        stream.Position = UDim2.new(math.random(0, 100) / 100, 0, -0.5, 0)
        stream.TextXAlignment = Enum.TextXAlignment.Center
        stream.TextYAlignment = Enum.TextYAlignment.Top
        stream.ClipsDescendants = false
        
        -- Generate binary text
        local binaryText = ""
        for j = 1, 30 do
            binaryText = binaryText .. (math.random(0, 1) == 1 and "1" or "0") .. "\n"
        end
        stream.Text = binaryText
        
        table.insert(binaryStreams, {
            obj = stream,
            speed = math.random(5, 20) / 1000,
            resetY = math.random(-100, -50) / 100
        })
    end
    ...
    for i = 1, particleCount do
        ...
        particle.Parent = darkFrame
        particle.BackgroundColor3 = i % 3 == 0 and library.overlaySettings.accentColor or library.overlaySettings.primaryColor
        ...
        table.insert(particles, {
            obj = particle,
            speedX = (math.random(-5, 5)) / 1000,
            speedY = (math.random(5, 15)) / 1000,
            fadeSpeed = math.random(1, 4) / 100,
            fadeDir = math.random(0, 1) == 1 and 1 or -1
        })
    end
    ...
    for i = 1, hexCount do
        local hexLine = Instance.new("TextLabel")
        hexLine.Name = "HexLine" .. i
        hexLine.Parent = darkFrame
        hexLine.BackgroundTransparency = 1
        hexLine.BorderSizePixel = 0
        hexLine.Font = Enum.Font.Code
        hexLine.TextSize = 12
        hexLine.TextColor3 = library.overlaySettings.secondaryColor
        hexLine.TextTransparency = 0.7
        hexLine.Size = UDim2.new(0, 200, 0, 20)
        hexLine.Position = UDim2.new(math.random(-20, 120) / 100, 0, math.random(0, 100) / 100, 0)
        hexLine.TextXAlignment = Enum.TextXAlignment.Left
        
        local hexText = "0x"
        for j = 1, 8 do
            hexText = hexText .. hexChars[math.random(1, #hexChars)]
        end
        hexLine.Text = hexText
        
        table.insert(hexLines, {
            obj = hexLine,
            speed = math.random(-20, 20) / 1000,
            fadeSpeed = math.random(1, 2) / 100,
            fadeDir = 1
        })
    end
    ...
    scanline.Parent = darkFrame
    scanline.BackgroundColor3 = library.overlaySettings.primaryColor
    ...
    for i = 1, 12 do
        ...
        circuit.Name = "Circuit" .. i
        circuit.Parent = darkFrame
        circuit.BackgroundColor3 = library.overlaySettings.primaryColor
        circuit.BackgroundTransparency = 0.75
        circuit.BorderSizePixel = 0
        
        if math.random(0, 1) == 0 then
            circuit.Size = UDim2.new(math.random(5, 20) / 100, 0, 0, 2)
        else
            circuit.Size = UDim2.new(0, 2, math.random(5, 20) / 100, 0)
        end
        
        circuit.Position = UDim2.new(math.random(0, 100) / 100, 0, math.random(0, 100) / 100, 0)
        
        table.insert(circuitLines, {
            obj = circuit,
            pulseSpeed = math.random(50, 150) / 10000,
            pulseDir = 1
        })
    end
    ...
    connection = RunService.RenderStepped:Connect(function()
        if not library._backgroundOverlay or not library._backgroundOverlay.Parent then
            connection:Disconnect()
            return
        end
        
        -- Animate rain streams
        for _, rainData in pairs(rainStreams) do
            if rainData.obj and rainData.obj.Parent then
                local currentY = rainData.obj.Position.Y.Scale
                local newY = currentY + (rainData.speed * library.overlaySettings.animationSpeed)
                
                if newY > 1.3 then
                    newY = rainData.resetY
                    rainData.obj.Position = UDim2.new(math.random(0, 100) / 100, 0, newY, 0)
                    ...
                    rainData.obj.Text = rainText
                else
                    rainData.obj.Position = UDim2.new(rainData.obj.Position.X.Scale, 0, newY, 0)
                end
            end
        end
        
        -- Animate binary streams
        for _, streamData in pairs(binaryStreams) do
            if streamData.obj and streamData.obj.Parent then
                local currentY = streamData.obj.Position.Y.Scale
                local newY = currentY + (streamData.speed * library.overlaySettings.animationSpeed)
                
                if newY > 1.2 then
                    newY = streamData.resetY
                    streamData.obj.Position = UDim2.new(math.random(0, 100) / 100, 0, newY, 0)
                    
                    -- Regenerate binary text
                    local binaryText = ""
                    for j = 1, 30 do
                        binaryText = binaryText .. (math.random(0, 1) == 1 and "1" or "0") .. "\n"
                    end
                    streamData.obj.Text = binaryText
                else
                    streamData.obj.Position = UDim2.new(streamData.obj.Position.X.Scale, 0, newY, 0)
                end
            end
        end
        ...
        for _, particleData in pairs(particles) do
            if particleData.obj and particleData.obj.Parent then
                local currentX = particleData.obj.Position.X.Scale
                local currentY = particleData.obj.Position.Y.Scale
                local newX = currentX + (particleData.speedX * library.overlaySettings.animationSpeed)
                local newY = currentY + (particleData.speedY * library.overlaySettings.animationSpeed)
                ...
                particleData.obj.Position = UDim2.new(newX, 0, newY, 0)
                
                -- Fade effect
                local currentTrans = particleData.obj.BackgroundTransparency
                local newTrans = currentTrans + (particleData.fadeSpeed * particleData.fadeDir * library.overlaySettings.animationSpeed)
                
                if newTrans > 0.95 then
                    particleData.fadeDir = -1
                elseif newTrans < 0.4 then
                    particleData.fadeDir = 1
                end
                
                particleData.obj.BackgroundTransparency = math.clamp(newTrans, 0.4, 0.95)
            end
        end
        
        -- Animate hex lines
        for _, hexData in pairs(hexLines) do
            if hexData.obj and hexData.obj.Parent then
                local currentX = hexData.obj.Position.X.Scale
                local newX = currentX + (hexData.speed * library.overlaySettings.animationSpeed)
                
                if newX > 1.2 then newX = -0.2 end
                if newX < -0.2 then newX = 1.2 end
                
                hexData.obj.Position = UDim2.new(newX, 0, hexData.obj.Position.Y.Scale, 0)
                
                local currentTrans = hexData.obj.TextTransparency
                local newTrans = currentTrans + (hexData.fadeSpeed * hexData.fadeDir * library.overlaySettings.animationSpeed)
                
                if newTrans > 0.9 then
                    hexData.fadeDir = -1
                elseif newTrans < 0.5 then
                    hexData.fadeDir = 1
                end
                
                hexData.obj.TextTransparency = math.clamp(newTrans, 0.5, 0.9)
            end
        end
        
        -- Animate scanline
        scanlineY = scanlineY + (0.003 * library.overlaySettings.animationSpeed)
        if scanlineY > 1 then scanlineY = 0 end
        scanline.Position = UDim2.new(0, 0, scanlineY, 0)
        
        -- Pulse circuit lines
        for _, circuitData in pairs(circuitLines) do
            if circuitData.obj and circuitData.obj.Parent then
                local currentTrans = circuitData.obj.BackgroundTransparency
                local newTrans = currentTrans + (circuitData.pulseSpeed * circuitData.pulseDir * library.overlaySettings.animationSpeed)
                
                if newTrans > 0.9 then
                    circuitData.pulseDir = -1
                elseif newTrans < 0.5 then
                    circuitData.pulseDir = 1
                end
                
                circuitData.obj.BackgroundTransparency = math.clamp(newTrans, 0.5, 0.9)
            end
        end
    end)
end

function library:RemoveBackgroundOverlay()
    if library._backgroundOverlay then
        library._backgroundOverlay:Destroy()
        library._backgroundOverlay = nil
        library._backgroundOverlayFrame = nil
    end
end
...
-- ========================================
function library:CreateSnowflakeBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(10, 15, 25)
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    ...
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "snowflake"
    ...
    for i = 1, 60 do
        ...
        snowflake.Parent = darkFrame
        snowflake.BackgroundTransparency = 1
        snowflake.Font = Enum.Font.Code
        snowflake.Text = "❄"
        snowflake.TextSize = math.random(16, 32)
        snowflake.TextColor3 = Color3.fromRGB(200, 220, 255)
        snowflake.TextTransparency = math.random(10, 40) / 100
        snowflake.Size = UDim2.new(0, 30, 0, 30)
        snowflake.Position = UDim2.new(math.random(0, 100) / 100, 0, math.random(-20, 0) / 100, 0)
        
        table.insert(snowflakes, {
            obj = snowflake,
            speed = math.random(10, 25) / 1000,
            drift = math.random(-2, 2) / 1000
        })
    end
    
    RunService.RenderStepped:Connect(function()
        if not library._backgroundOverlay or not library._backgroundOverlay.Parent then return end
        for _, snow in pairs(snowflakes) do
            if snow.obj and snow.obj.Parent then
                local currentX = snow.obj.Position.X.Scale
                local currentY = snow.obj.Position.Y.Scale
                local newX = currentX + (snow.drift * library.overlaySettings.speed)
                local newY = currentY + (snow.speed * library.overlaySettings.speed)
                ...
                snow.obj.Position = UDim2.new(newX, 0, newY, 0)
            end
        end
    end)
end
...
-- ========================================
function library:CreateCherryBlossomBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(25, 15, 20)
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    ...
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "cherry"
    ...
    for i = 1, 50 do
        ...
        petal.Name = "Petal" .. i
        petal.Parent = darkFrame
        petal.BackgroundTransparency = 1
        petal.Font = Enum.Font.Code
        petal.Text = "🌸"
        petal.TextSize = math.random(14, 28)
        petal.TextTransparency = math.random(10, 30) / 100
        petal.Size = UDim2.new(0, 30, 0, 30)
        petal.Position = UDim2.new(math.random(0, 100) / 100, 0, math.random(-20, 0) / 100, 0)
        petal.Rotation = math.random(0, 360)
        
        table.insert(petals, {
            obj = petal,
            speed = math.random(8, 20) / 1000,
            drift = math.random(-3, 3) / 1000,
    ...
    RunService.RenderStepped:Connect(function()
        if not library._backgroundOverlay or not library._backgroundOverlay.Parent then return end
        for _, petal in pairs(petals) do
            if petal.obj and petal.obj.Parent then
                local currentX = petal.obj.Position.X.Scale
                local currentY = petal.obj.Position.Y.Scale
                local newX = currentX + (petal.drift * library.overlaySettings.speed)
                local newY = currentY + (petal.speed * library.overlaySettings.speed)
                ...
                petal.obj.Position = UDim2.new(newX, 0, newY, 0)
                petal.obj.Rotation = petal.obj.Rotation + (petal.rotation * library.overlaySettings.speed)
            end
        end
    end)
end
...
-- HEART CUTE THEME
-- ========================================
function library:CreateHeartBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(20, 10, 15)
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    ...
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "heart"
    ...
    for i = 1, 40 do
        ...
        heart.Name = "Heart" .. i
        heart.Parent = darkFrame
        heart.BackgroundTransparency = 1
        heart.Font = Enum.Font.Code
        heart.Text = "💗"
        heart.TextSize = math.random(16, 36)
        heart.TextTransparency = math.random(20, 50) / 100
        heart.Size = UDim2.new(0, 40, 0, 40)
        heart.Position = UDim2.new(math.random(0, 100) / 100, 0, math.random(100, 120) / 100, 0)
        
        table.insert(hearts, {
            obj = heart,
            speed = math.random(10, 25) / 1000,
            wobble = math.random(-1, 1) / 1000
        })
    end
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, heart in pairs(hearts) do
            if heart.obj and heart.obj.Parent then
                local currentX = heart.obj.Position.X.Scale
                local currentY = heart.obj.Position.Y.Scale
                local newX = currentX + (heart.wobble * library.overlaySettings.speed)
                local newY = currentY - (heart.speed * library.overlaySettings.speed)
                ...
                heart.obj.Position = UDim2.new(newX, 0, newY, 0)
            end
        end
    end)
end
...
-- ========================================
-- STAR NIGHT SKY THEME
-- ========================================
function library:CreateStarBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(5, 5, 20)
    darkFrame.BackgroundTransparency = 0.2
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "star"
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, star in pairs(stars) do
            if star.obj and star.obj.Parent then
                local currentTrans = star.obj.TextTransparency
                local newTrans = currentTrans + (star.fadeSpeed * star.fadeDir * library.overlaySettings.speed)
                
                if newTrans > 0.9 then
                    star.fadeDir = -1
                elseif newTrans < 0.2 then
                    star.fadeDir = 1
                end
                
                star.obj.TextTransparency = math.clamp(newTrans, 0.2, 0.9)
            end
        end
    end)
end
...
-- ========================================
-- BUBBLE UNDERWATER THEME
-- ========================================
function library:CreateBubbleBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(0, 10, 20)
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    ...
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "bubble"
    ...
    for i = 1, 45 do
        ...
        bubble.Parent = darkFrame
        bubble.BackgroundColor3 = Color3.fromRGB(100, 180, 220)
        bubble.BackgroundTransparency = 0.7
        bubble.BorderSizePixel = 0
        local size = math.random(10, 30)
        bubble.Size = UDim2.new(0, size, 0, size)
        bubble.Position = UDim2.new(math.random(0, 100) / 100, 0, math.random(100, 120) / 100, 0)
        ...
        table.insert(bubbles, {
            obj = bubble,
            speed = math.random(15, 35) / 1000,
            wobble = math.random(-2, 2) / 1000
        })
    end
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, bubble in pairs(bubbles) do
            if bubble.obj and bubble.obj.Parent then
                local currentX = bubble.obj.Position.X.Scale
                local currentY = bubble.obj.Position.Y.Scale
                local newX = currentX + (bubble.wobble * library.overlaySettings.speed)
                local newY = currentY - (bubble.speed * library.overlaySettings.speed)
                ...
                bubble.obj.Position = UDim2.new(newX, 0, newY, 0)
            end
        end
    end)
end
...
-- AUTUMN LEAVES THEME
-- ========================================
function library:CreateAutumnBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(20, 10, 5)
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    ...
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "autumn"
    ...
    for i = 1, 50 do
        ...
        leaf.Name = "Leaf" .. i
        leaf.Parent = darkFrame
        leaf.BackgroundTransparency = 1
        leaf.Font = Enum.Font.Code
        leaf.Text = leafEmojis[math.random(1, #leafEmojis)]
        leaf.TextSize = math.random(18, 32)
        leaf.TextTransparency = math.random(10, 30) / 100
        leaf.Size = UDim2.new(0, 35, 0, 35)
        leaf.Position = UDim2.new(math.random(0, 100) / 100, 0, math.random(-20, 0) / 100, 0)
        leaf.Rotation = math.random(0, 360)
        
        table.insert(leaves, {
            obj = leaf,
            speed = math.random(12, 28) / 1000,
            drift = math.random(-4, 4) / 1000,
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, leaf in pairs(leaves) do
            if leaf.obj and leaf.obj.Parent then
                local currentX = leaf.obj.Position.X.Scale
                local currentY = leaf.obj.Position.Y.Scale
                local newX = currentX + (leaf.drift * library.overlaySettings.speed)
                local newY = currentY + (leaf.speed * library.overlaySettings.speed)
                
                if newY > 1.1 then
                    newY = -0.1
                    newX = math.random(0, 100) / 100
                    leaf.obj.Rotation = math.random(0, 360)
                end
                
                leaf.obj.Position = UDim2.new(newX, 0, newY, 0)
                leaf.obj.Rotation = leaf.obj.Rotation + (leaf.rotation * library.overlaySettings.speed)
            end
        end
    end)
end
...
-- RAINBOW PRIDE THEME
-- ========================================
function library:CreateRainbowBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(15, 10, 20)
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    ...
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "rainbow"
    ...
    for i = 1, 60 do
        ...
        sparkle.Parent = darkFrame
        sparkle.BackgroundColor3 = rainbowColors[math.random(1, #rainbowColors)]
        ...
        table.insert(sparkles, {
            ...
            fadeDir = 1,
            colorIndex = math.random(1, #rainbowColors)
        })
    end
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, sparkle in pairs(sparkles) do
            if sparkle.obj and sparkle.obj.Parent then
                local currentTrans = sparkle.obj.BackgroundTransparency
                local newTrans = currentTrans + (sparkle.fadeSpeed * sparkle.fadeDir * library.overlaySettings.speed)
                
                if newTrans > 0.9 then
                    sparkle.fadeDir = -1
                    sparkle.colorIndex = (sparkle.colorIndex % #rainbowColors) + 1
                    sparkle.obj.BackgroundColor3 = rainbowColors[sparkle.colorIndex]
                elseif newTrans < 0.3 then
                    sparkle.fadeDir = 1
                end
                
                sparkle.obj.BackgroundTransparency = math.clamp(newTrans, 0.3, 0.9)
            end
        end
    end)
end
...
-- ========================================
-- I LOVE FEMBOYS TEXT SPAM THEME
-- ========================================
function library:CreateFemboysBackground()
    library:RemoveBackgroundOverlay()
    ...
    darkFrame.Name = "DarkOverlay"
    darkFrame.Parent = overlay
    darkFrame.BackgroundColor3 = Color3.fromRGB(20, 10, 20)
    darkFrame.BackgroundTransparency = 0.3
    darkFrame.BorderSizePixel = 0
    darkFrame.Size = UDim2.new(1, 0, 1, 0)
    ...
    library._backgroundOverlay = overlay
    library._backgroundOverlayFrame = darkFrame
    library.overlaySettings.currentStyle = "femboys"
    
    -- Create floating text
    local texts = {}
    for i = 1, 50 do
        local text = Instance.new("TextLabel")
        text.Name = "FemboysText" .. i
        text.Parent = darkFrame
        text.BackgroundTransparency = 1
        text.Font = Enum.Font.GothamBold
        text.Text = "I LOVE FEMBOYS"
        text.TextSize = math.random(14, 32)
        text.TextColor3 = Color3.fromRGB(255, 150, 200)
        text.TextTransparency = math.random(20, 60) / 100
        text.Size = UDim2.new(0, 200, 0, 40)
        text.Position = UDim2.new(math.random(0, 100) / 100, 0, math.random(0, 120) / 100, 0)
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, textData in pairs(texts) do
            if textData.obj and textData.obj.Parent then
                local currentX = textData.obj.Position.X.Scale
                local currentY = textData.obj.Position.Y.Scale
                local newX = currentX + (textData.drift * library.overlaySettings.speed)
                local newY = currentY + (textData.speed * library.overlaySettings.speed)
                ...
                textData.obj.Position = UDim2.new(newX, 0, newY, 0)
                textData.obj.Rotation = textData.obj.Rotation + (textData.rotation * library.overlaySettings.speed)
            end
        end
    end)
end
...
function library:Watermark(text)
    ...
    edge.BackgroundColor3 = library.theme.edge
    edge.Position = UDim2.new(0.5, 0, -0.03, 0)
    edge.Size = UDim2.new(0, 0, 0, 26)
    edge.BackgroundTransparency = 1

    edgeCorner.CornerRadius = UDim.new(0, library.theme.cornerRadius)
    ...
    backgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.theme.backgroundLight), ColorSequenceKeypoint.new(1.00, library.theme.backgroundDark)}
    ...
    waterText.Text = text
    waterText.TextColor3 = library.theme.textPrimary
...
function library:InitNotifications(text, duration, callback)
    ...
    function Notification:Notify(text, duration, type, callback)
        ...
        bar.Parent = barFolder
        bar.BackgroundColor3 = library.theme.accent
        bar.BackgroundTransparency = library.theme.barTransparency
        bar.Size = UDim2.new(0, 0, 0, 1)
        ...
        backgroundCorner.CornerRadius = UDim.new(0, library.theme.cornerRadius)
        backgroundCorner.Name = "backgroundCorner"
        backgroundCorner.Parent = background
        ...
        notifText.Text = text
        notifText.TextColor3 = library.theme.textPrimary
...
-- Drawing API capabilities detection
...
local function TestDrawingAPI()
    ...
    drawingCapabilities.available = true
    
    local testTypes = {"Circle", "Line", "Square", "Text", "Triangle", "Quad", "Image"}
    
    for _, drawType in ipairs(testTypes) do
        local success = pcall(function()
            local test = Drawing.new(drawType)
            if test then
                drawingCapabilities[drawType] = true
                test:Remove()
            end
        end)
    end
...
local function LoadImageFromURL(url, filename)
    filename = filename or "intro_image.png"
    
    -- Method 1: Try request() for binary data (most reliable)
    if assetFunctions.request and assetFunctions.writefile then
        local success, result = pcall(function()
            local response = assetFunctions.request({
                Url = url,
                Method = "GET"
            })
            ...
            if response and response.StatusCode == 200 and response.Body then
                -- Write binary data
                assetFunctions.writefile(filename, response.Body)
                
                -- Return both asset URL and file path
                local assetUrl = nil
                if assetFunctions.getcustomasset then
                    assetUrl = assetFunctions.getcustomasset(filename)
                elseif assetFunctions.getsynasset then
                    assetUrl = assetFunctions.getsynasset(filename)
                end
                
                return {assetUrl = assetUrl, filePath = filename, method = "request"}
            end
        end)
    ...
    -- Method 2: Try HttpGet (fallback)
    if assetFunctions.HttpGet and assetFunctions.writefile then
        local success, result = pcall(function()
            local data = game:HttpGet(url, true) -- true for binary mode
            assetFunctions.writefile(filename, data)
            ...
            return {assetUrl = assetUrl, filePath = filename, method = "HttpGet"}
        end)
    ...
    return nil, "All download methods failed"
end
...
function library:Introduction()
    ...
    -- Drawing API detection display
    debugText.Name = "debugText"
    debugText.Parent = background
    debugText.AnchorPoint = Vector2.new(0.5, 0)
    debugText.BackgroundTransparency = 1
    debugText.Position = UDim2.new(0.5, 0, 0.05, 0)
    debugText.Size = UDim2.new(0, 280, 0, 80)
    debugText.Font = Enum.Font.Code
    debugText.TextSize = 10
    debugText.TextTransparency = 1
    debugText.TextColor3 = Color3.fromRGB(100, 255, 100)
    debugText.TextXAlignment = Enum.TextXAlignment.Left
    debugText.TextYAlignment = Enum.TextYAlignment.Top
    
    local apiStatus = "Drawing API: " .. (drawingCapabilities.available and "✓" or "✗") .. "\n"
    for _, dtype in ipairs({"Circle", "Line", "Square", "Text", "Triangle", "Quad", "Image"}) do
        apiStatus = apiStatus .. dtype .. ": " .. (drawingCapabilities[dtype] and "✓" or "✗") .. "\n"
    end
    apiStatus = apiStatus .. "\nAsset Functions:\n"
    apiStatus = apiStatus .. "getcustomasset: " .. (assetFunctions.getcustomasset and "✓" or "✗") .. "\n"
    apiStatus = apiStatus .. "getsynasset: " .. (assetFunctions.getsynasset and "✓" or "✗") .. "\n"
    apiStatus = apiStatus .. "writefile: " .. (assetFunctions.writefile and "✓" or "✗") .. "\n"
    apiStatus = apiStatus .. "request: " .. (assetFunctions.request and "✓" or "✗") .. "\n"
    debugText.Text = apiStatus
    
    -- Image URL to load
    local imageURL = "https://i.imgur.com/Sm70iPQ.png"
    
    -- Create container for image
    local drawingObjects = {}
    local drawingContainer = Instance.new("Frame")
    drawingContainer.Name = "drawingContainer"
    drawingContainer.Parent = background
    drawingContainer.AnchorPoint = Vector2.new(0.5, 0.5)
    drawingContainer.BackgroundTransparency = 1
    drawingContainer.Position = UDim2.new(0.5, 0, 0.5, 0)
    drawingContainer.Size = UDim2.new(0, 200, 0, 200)
    
    -- Try to load image from URL
    local imageData, loadError = LoadImageFromURL(imageURL, "intro_image.png")
    local imageLoaded = false
    local loadMethod = "none"
    
    -- Try multiple display methods if image was loaded
    if imageData then
        -- Method 1: Try ImageLabel with asset URL (most compatible)
        if imageData.assetUrl and not imageLoaded then
            local success = pcall(function()
                local imageLabel = Instance.new("ImageLabel")
                imageLabel.Name = "loadedImage"
                imageLabel.Parent = drawingContainer
                imageLabel.AnchorPoint = Vector2.new(0.5, 0.5)
                imageLabel.BackgroundTransparency = 1
                imageLabel.Position = UDim2.new(0.5, 0, 0.5, 0)
                imageLabel.Size = UDim2.new(1, 0, 1, 0)
                imageLabel.Image = imageData.assetUrl
                imageLabel.ImageTransparency = 1
                imageLoaded = true
                loadMethod = "ImageLabel (" .. imageData.method .. ")"
                
                -- Pulse animation
                CreateTween("imagePulse", 0.8)
                coroutine.wrap(function()
                    while imageLabel and imageLabel.Parent do
                        TweenService:Create(imageLabel, TweenTable["imagePulse"], {Size = UDim2.new(1.05, 0, 1.05, 0)}):Play()
                        wait(0.8)
                        TweenService:Create(imageLabel, TweenTable["imagePulse"], {Size = UDim2.new(1, 0, 1, 0)}):Play()
                        wait(0.8)
                    end
                end)()
            end)
        ...
        -- Method 2: Try Drawing.new("Image") with file path
        if not imageLoaded and drawingCapabilities.available and drawingCapabilities.Image and imageData.filePath then
            local success = pcall(function()
                local screenCenter = Vector2.new(edge.AbsolutePosition.X + edge.AbsoluteSize.X/2, edge.AbsolutePosition.Y + edge.AbsoluteSize.Y/2)
                
                local drawingImage = Drawing.new("Image")
                drawingImage.Visible = true
                drawingImage.Transparency = 0
                
                -- Try different ways to set image data
                if assetFunctions.readfile then
                    drawingImage.Data = assetFunctions.readfile(imageData.filePath)
                else
                    drawingImage.Data = imageData.filePath
                end
                
                drawingImage.Size = Vector2.new(200, 200)
                drawingImage.Position = Vector2.new(screenCenter.X - 100, screenCenter.Y - 100)
                table.insert(drawingObjects, drawingImage)
                imageLoaded = true
                loadMethod = "Drawing.Image (" .. imageData.method .. ")"
                
                -- Pulse animation
                spawn(function()
                    local pulseTime = 0
                    while introduction and introduction.Parent and drawingImage do
                        pulseTime = pulseTime + 0.016
                        local scale = 1 + math.sin(pulseTime * 2) * 0.05
                        drawingImage.Size = Vector2.new(200 * scale, 200 * scale)
                        drawingImage.Position = Vector2.new(screenCenter.X - 100 * scale, screenCenter.Y - 100 * scale)
                        wait(0.016)
                    end
                end)
            end)
        ...
        -- Update debug text with load method
        if imageLoaded then
            debugText.Text = debugText.Text .. "\nImage loaded: " .. loadMethod
        end
    end
    ...
    if not imageLoaded then
        ...
        emojiText.Parent = drawingContainer
        emojiText.AnchorPoint = Vector2.new(0.5, 0.5)
        emojiText.BackgroundTransparency = 1
        emojiText.Position = UDim2.new(0.5, 0, 0.5, 0)
        emojiText.Size = UDim2.new(1, 0, 1, 0)
        emojiText.Font = Enum.Font.GothamBold
        emojiText.Text = "💗"
        emojiText.TextSize = 120
        emojiText.TextTransparency = 1
        emojiText.TextColor3 = library.theme.accent
        
        -- Update debug text with error if any
        if loadError then
            debugText.Text = debugText.Text .. "\nImage Load Error:\n" .. loadError
        end
        
        -- Pulse animation
        CreateTween("heartPulse", 0.8)
        coroutine.wrap(function()
            while emojiText and emojiText.Parent do
                TweenService:Create(emojiText, TweenTable["heartPulse"], {TextSize = 130}):Play()
                wait(0.8)
                TweenService:Create(emojiText, TweenTable["heartPulse"], {TextSize = 120}):Play()
                wait(0.8)
            end
        end)()
    end
    ...
    mainText.Size = UDim2.new(0, 280, 0, 40)
    mainText.Font = Enum.Font.GothamBold
    mainText.Text = "I LOVE FEMBOYS"
    mainText.TextColor3 = library.theme.accent
    mainText.TextSize = 24
    mainText.TextTransparency = 1
    mainText.TextStrokeTransparency = 0.8
    mainText.TextStrokeColor3 = Color3.fromRGB(255, 150, 200)
    ...
    wait(.2)
    TweenService:Create(debugText, TweenTable["introduction"], {TextTransparency = 0.3}):Play()
    
    -- Fade in image or emoji
    if imageLoaded then
        local imageObj = drawingContainer:FindFirstChild("loadedImage")
        if imageObj then
            TweenService:Create(imageObj, TweenTable["introduction"], {ImageTransparency = 0}):Play()
        end
    else
        local emojiObj = drawingContainer:FindFirstChild("emojiText")
        if emojiObj then
            TweenService:Create(emojiObj, TweenTable["introduction"], {TextTransparency = 0}):Play()
        end
    end
    
    wait(.3)
    TweenService:Create(mainText, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(3)
    
    -- Fade out image or emoji
    if imageLoaded then
        local imageObj = drawingContainer:FindFirstChild("loadedImage")
        if imageObj then
            TweenService:Create(imageObj, TweenTable["introduction"], {ImageTransparency = 1}):Play()
        end
    else
        local emojiObj = drawingContainer:FindFirstChild("emojiText")
        if emojiObj then
            TweenService:Create(emojiObj, TweenTable["introduction"], {TextTransparency = 1}):Play()
        end
    end
    
    TweenService:Create(debugText, TweenTable["introduction"], {TextTransparency = 1}):Play()
    TweenService:Create(mainText, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.2)
...
-- Resize system
library.resizeMode = false
library.resizeCursor = nil
library.resizeExitButton = nil
library.mainEdge = nil

function library:EnableResizeMode()
    if library.resizeMode then return end
    library.resizeMode = true
    
    -- Create custom cursor
    if not library.resizeCursor then
        local cursorGui = Instance.new("ScreenGui")
        cursorGui.Name = "ResizeCursor"
        cursorGui.Parent = CoreGuiService
        ...
        innerFrame.Parent = cursorFrame
        innerFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        innerFrame.BorderSizePixel = 0
        innerFrame.Size = UDim2.new(0, 10, 0, 10)
        ...
        library.resizeCursor = cursorGui
        library.resizeCursorFrame = cursorFrame
        
        -- Update cursor position
        RunService.RenderStepped:Connect(function()
            if library.resizeMode and cursorFrame then
    ...
    library.resizeCursor.Enabled = true
    
    -- Create exit button that follows GUI
    if library.mainEdge and not library.resizeExitButton then
        local exitGui = Instance.new("ScreenGui")
        exitGui.Name = "ResizeExitButton"
        exitGui.Parent = CoreGuiService
        exitGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        exitGui.DisplayOrder = 999998
        ...
        library.resizeExitButton = exitGui
        library.resizeExitButtonFrame = exitButton
        
        -- Position update
        local lastMouseMove = tick()
        local cursorStopDelay = 0.5
        
        RunService.RenderStepped:Connect(function()
            if library.resizeMode and library.mainEdge and exitButton then
                local edgePos = library.mainEdge.AbsolutePosition
                local edgeSize = library.mainEdge.AbsoluteSize
                exitButton.Position = UDim2.new(0, edgePos.X + edgeSize.X + 10, 0, edgePos.Y - 10)
                
                -- Check if cursor stopped moving
                local mousePos = UserInputService:GetMouseLocation()
                if library._lastMousePos then
                    if (mousePos - library._lastMousePos).Magnitude > 1 then
                        lastMouseMove = tick()
                        exitButton.Visible = false
                    end
                end
                library._lastMousePos = mousePos
                
                if (tick() - lastMouseMove) > cursorStopDelay then
        ...
        exitButton.MouseButton1Click:Connect(function()
            library:DisableResizeMode()
        end)
    end
    
    if library.resizeExitButton then
        library.resizeExitButton.Enabled = true
    end
    
    -- Enable resize on main edge
    if library.mainEdge then
        library.mainEdge.Active = true
        library.mainEdge.Draggable = false -- We'll handle this custom
    end
end

function library:DisableResizeMode()
    if not library.resizeMode then return end
    library.resizeMode = false
    
    if library.resizeCursor then
        library.resizeCursor.Enabled = false
    end
    
    if library.resizeExitButton then
        library.resizeExitButton.Enabled = false
    end
end
...
function library:Init(key)
    ...
    library:TrackElement(edge, "background")
    library.mainEdge = edge
    ...
    edge.InputBegan:Connect(function(input)
        if library.resizeMode and input.UserInputType == Enum.UserInputType.MouseButton1 then
            resizing = true
    ...
    UserInputService.InputChanged:Connect(function(input)
        if resizing and library.resizeMode and input.UserInputType == Enum.UserInputType.MouseMovement then
            ...
            edge.Size = UDim2.new(0, newWidth, 0, newHeight)
            background.Size = UDim2.new(0, newWidth - 2, 0, newHeight - 2)
            
            -- Update container sizes
            local barWidth = newWidth - 2
            bar.Size = UDim2.new(0, barWidth, 0, 1)
            headerLabel.Size = UDim2.new(0, barWidth, 0, 38)
            
            local tabButtonHeight = newHeight - 46
            tabButtonsEdge.Size = UDim2.new(0, 152, 0, tabButtonHeight)
            tabButtons.Size = UDim2.new(0, 150, 0, tabButtonHeight - 2)
            
            local containerWidth = newWidth - 168
            containerEdge.Size = UDim2.new(0, containerWidth, 0, tabButtonHeight)
            container.Size = UDim2.new(0, containerWidth - 2, 0, tabButtonHeight - 2)
        end
    end)
    ...
    UserInputService.InputBegan:Connect(function(input)
        if CanChangeVisibility and input.KeyCode == key then
            ...
            -- Toggle overlay visibility with GUI
            if library._backgroundOverlay then
                library._backgroundOverlay.Enabled = edge.Visible
            end
        end
    end)
    ...
    backgroundGradient.Name = "backgroundGradient"
    backgroundGradient.Parent = background
    library:TrackElement(backgroundGradient, "backgroundGradient")
    ...
    headerLabel.Font = library.currentFont
    headerLabel.Text = title
    headerLabel.TextColor3 = library.theme.textPrimary
    library:TrackElement(headerLabel, "text", "primary")
    library:TrackText(headerLabel)
    ...
    tabButtonsEdge.BackgroundColor3 = library.theme.edgeDark
    tabButtonsEdge.Position = UDim2.new(0.1435, 0, 0.536000013, 0)
    tabButtonsEdge.Size = UDim2.new(0, 152, 0, 360)
    library:TrackElement(tabButtonsEdge, "edgeDark")
    ...
    tabButtonsGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.theme.backgroundLight), ColorSequenceKeypoint.new(1.00, library.theme.backgroundDark)}
    tabButtonsGradient.Rotation = 90
    tabButtonsGradient.Name = "tabButtonsGradient"
    tabButtonsGradient.Parent = tabButtons
    library:TrackElement(tabButtonsGradient, "backgroundGradient")
    ...
    containerGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.theme.backgroundLight), ColorSequenceKeypoint.new(1.00, library.theme.backgroundDark)}
    containerGradient.Rotation = 90
    containerGradient.Name = "containerGradient"
    containerGradient.Parent = container
    library:TrackElement(containerGradient, "backgroundGradient")
    ...
    function TabLibrary:NewTab(title)
        ...
        tabButton.TextColor3 = library.theme.textDimmed
        tabButton.TextSize = 15.000
        tabButton.RichText = true
        library:TrackText(tabButton)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in pairs(tabButtons:GetChildren()) do
                if v:IsA("TextButton") then
                    TweenService:Create(v, TweenTable["tab_text_colour"], {TextColor3 = library.theme.textDimmed}):Play()
                end
            end
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = library.theme.accent}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.BackgroundColor3 = library.theme.buttonIdle
            ...
            buttonGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.theme.backgroundLight), ColorSequenceKeypoint.new(1.00, library.theme.backgroundDark)}
            ...
            buttonLabel.Font = library.currentFont
            buttonLabel.Text = text
            buttonLabel.TextColor3 = library.theme.textSecondary
            buttonLabel.TextSize = 14.000
            buttonLabel.RichText = true
            library:TrackText(buttonLabel)

            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = library.theme.buttonHover}):Play()
            end)
            button.MouseLeave:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = library.theme.buttonIdle}):Play()
            end)

            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = library.theme.accent}):Play()
            end)
            button.MouseButton1Up:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = library.theme.textSecondary}):Play()
            end)
        ...
        function Components:NewSection(text)
            ...
            sectionLabel.Font = library.currentFont
            sectionLabel.LineHeight = 1
            sectionLabel.Text = text
            sectionLabel.TextColor3 = library.theme.textSecondary
            sectionLabel.TextSize = 14.000
            sectionLabel.TextXAlignment = Enum.TextXAlignment.Left
            sectionLabel.RichText = true
            library:TrackText(sectionLabel)
            ...
            rightBar.BackgroundColor3 = library.theme.edge
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleEdge.BackgroundColor3 = library.theme.edgeDark
            ...
            toggleGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.theme.backgroundLight), ColorSequenceKeypoint.new(1.00, library.theme.backgroundDark)}
            ...
            library:TrackElement(toggleDesign, "accent")
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.theme.accent), ColorSequenceKeypoint.new(1.00, library.theme.accentDark)}
            toggleDesignGradient.Rotation = 90
            toggleDesignGradient.Name = "toggleDesignGradient"
            toggleDesignGradient.Parent = toggleDesign
            library:TrackElement(toggleDesignGradient, "toggleGradient")
            ...
            toggleLabel.Font = library.currentFont
            toggleLabel.LineHeight = 1.150
            toggleLabel.Text = text
            toggleLabel.TextColor3 = library.theme.textSecondary
            toggleLabel.TextSize = 14.000
            toggleLabel.TextXAlignment = Enum.TextXAlignment.Left
            toggleLabel.RichText = true
            library:TrackText(toggleLabel)
            ...
            toggleButton.MouseEnter:Connect(function()
                TweenService:Create(toggleLabel, TweenTable["hover"], {TextColor3 = library.theme.textBright}):Play()
            end)
            toggleButton.MouseLeave:Connect(function()
                TweenService:Create(toggleLabel, TweenTable["hover"], {TextColor3 = library.theme.textSecondary}):Play()
            end)
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybind.BackgroundColor3 = library.theme.edgeDark
                ...
                keybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.theme.backgroundLight), ColorSequenceKeypoint.new(1.00, library.theme.backgroundDark)}
                ...
                keybindButtonLabel.Font = library.currentFont
                keybindButtonLabel.Text = ". . ."
                keybindButtonLabel.TextColor3 = library.theme.textSecondary
                keybindButtonLabel.TextSize = 14.000
                keybindButtonLabel.RichText = true
                library:TrackText(keybindButtonLabel)
        ...
        function Components:NewKeybind(text, default, callback)
            ...
            keybindLabel.Font = library.currentFont
            keybindLabel.Text = text
            keybindLabel.TextColor3 = library.theme.textSecondary
            keybindLabel.TextSize = 14.000
            keybindLabel.TextWrapped = true
            keybindLabel.TextXAlignment = Enum.TextXAlignment.Left
            keybindLabel.RichText = true
            library:TrackText(keybindLabel)
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Font = library.currentFont
                textBoxValues.PlaceholderColor3 = library.theme.textDimmed
                textBoxValues.PlaceholderText = place
                textBoxValues.Text = ""
                textBoxValues.TextColor3 = library.theme.textSecondary
                ...
                selectionFrame.BackgroundColor3 = library.theme.accent
                selectionFrame.BackgroundTransparency = 0.5
                selectionFrame.BorderSizePixel = 0
                textBoxValues.TextEditable = true
                
                library:TrackText(textBoxValues)
                library:TrackElement(selectionFrame, "accent")
        ...
        function Components:NewColorPicker(text, default, callback)
            ...
            local pickerButtonBack = Instance.new("Frame")
            local pickerButtonBackCorner = Instance.new("UICorner")
            local pickerColorDisplay = Instance.new("Frame")
            local pickerColorCorner = Instance.new("UICorner")
            
            pickerFrame.Name = "pickerFrame"
            pickerFrame.Parent = page
            pickerFrame.BackgroundTransparency = 1
            pickerFrame.Size = UDim2.new(0, 396, 0, 24)
            
            pickerLayout.Name = "pickerLayout"
            ...
            pickerLabel.Size = UDim2.new(0, 300, 0, 24)
            pickerLabel.Font = library.currentFont
            pickerLabel.Text = text
            pickerLabel.TextColor3 = library.theme.textSecondary
            pickerLabel.TextSize = 14
            pickerLabel.TextXAlignment = Enum.TextXAlignment.Left
            pickerLabel.RichText = true
            library:TrackElement(pickerLabel, "text", "secondary")
            library:TrackText(pickerLabel)
            
            pickerPadding.Name = "pickerPadding"
            pickerPadding.Parent = pickerLabel
            pickerPadding.PaddingLeft = UDim.new(0, 2)
            
            pickerButton.Name = "pickerButton"
            pickerButton.Parent = pickerFrame
            pickerButton.BackgroundColor3 = library.theme.edgeDark
            pickerButton.Size = UDim2.new(0, 87, 0, 22)
            pickerButton.AutoButtonColor = false
            pickerButton.Font = Enum.Font.SourceSans
            pickerButton.Text = ""
            library:TrackElement(pickerButton, "edgeDark")
            
            pickerButtonCorner.CornerRadius = UDim.new(0, library.theme.cornerRadius)
            pickerButtonCorner.Parent = pickerButton
            
            pickerButtonLayout.Name = "pickerButtonLayout"
            pickerButtonLayout.Parent = pickerButton
            pickerButtonLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
            pickerButtonLayout.SortOrder = Enum.SortOrder.LayoutOrder
            pickerButtonLayout.VerticalAlignment = Enum.VerticalAlignment.Center
            
            pickerButtonBack.Name = "pickerButtonBack"
            pickerButtonBack.Parent = pickerButton
            pickerButtonBack.BackgroundColor3 = library.theme.backgroundLight
            pickerButtonBack.Size = UDim2.new(0, 85, 0, 20)
            library:TrackElement(pickerButtonBack, "backgroundGradient")
            
            pickerButtonBackCorner.CornerRadius = UDim.new(0, library.theme.cornerRadius)
            pickerButtonBackCorner.Parent = pickerButtonBack
            
            pickerColorDisplay.Name = "pickerColorDisplay"
            pickerColorDisplay.Parent = pickerButtonBack
            pickerColorDisplay.AnchorPoint = Vector2.new(0.5, 0.5)
            pickerColorDisplay.BackgroundColor3 = default
            pickerColorDisplay.BorderSizePixel = 0
            pickerColorDisplay.Position = UDim2.new(0.5, 0, 0.5, 0)
            pickerColorDisplay.Size = UDim2.new(0, 80, 0, 16)
            
            pickerColorCorner.CornerRadius = UDim.new(0, 2)
            pickerColorCorner.Parent = pickerColorDisplay
            ...
            pickerButton.MouseButton1Click:Connect(function()
                ...
                -- Create color picker in separate ScreenGui so it's visible
                local pickerGui = Instance.new("ScreenGui")
                pickerGui.Name = "ColorPickerPopup"
                pickerGui.Parent = CoreGuiService
                pickerGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
                pickerGui.DisplayOrder = 999
                ...
                pickerWindow.Parent = pickerGui
                pickerWindow.BackgroundColor3 = library.theme.backgroundLight
                pickerWindow.BorderSizePixel = 1
                pickerWindow.BorderColor3 = library.theme.edge
                
                -- Position near mouse cursor
                local mousePos = Mouse
                pickerWindow.Position = UDim2.new(0, Mouse.X + 10, 0, Mouse.Y - 65)
                pickerWindow.Size = UDim2.new(0, 200, 0, 130)
                pickerWindow.ZIndex = 10
                
                windowCorner.CornerRadius = UDim.new(0, library.theme.cornerRadius)
                windowCorner.Parent = pickerWindow
                
                windowLayout.Parent = pickerWindow
                windowLayout.SortOrder = Enum.SortOrder.LayoutOrder
                windowLayout.Padding = UDim.new(0, 4)
                
                windowPadding.Parent = pickerWindow
                windowPadding.PaddingTop = UDim.new(0, 6)
                windowPadding.PaddingBottom = UDim.new(0, 6)
                windowPadding.PaddingLeft = UDim.new(0, 8)
                windowPadding.PaddingRight = UDim.new(0, 8)
                
                -- RGB Sliders
                local function createSlider(name, initial)
                    local sliderFrame = Instance.new("Frame")
                    local sliderLabel = Instance.new("TextLabel")
                    ...
                    sliderLabel.TextColor3 = library.theme.textSecondary
                    sliderLabel.TextSize = 12
                    sliderLabel.TextXAlignment = Enum.TextXAlignment.Left
                    
                    sliderBar.Parent = sliderFrame
                    sliderBar.BackgroundColor3 = library.theme.edgeDark
                    sliderBar.Position = UDim2.new(0, 25, 0.3, 0)
                    ...
                    sliderFill.Size = UDim2.new(initial / 255, 0, 1, 0)
                    ...
                    sliderBar.InputBegan:Connect(function(input)
                        if input.UserInputType == Enum.UserInputType.MouseButton1 then
                            ...
                            while dragging do
                                ...
                                pickerColorDisplay.BackgroundColor3 = currentColor
                    ...
                    return {frame = sliderFrame, fill = sliderFill}
                end
                
                createSlider("R", currentColor.R * 255)
                createSlider("G", currentColor.G * 255)
                createSlider("B", currentColor.B * 255)
                ...
                closeButton.BackgroundColor3 = library.theme.accent
                closeButton.Size = UDim2.new(1, 0, 0, 20)
                closeButton.Font = Enum.Font.Code
                closeButton.Text = "close"
                closeButton.TextColor3 = library.theme.textPrimary
            ...
            function ColorPickerFunctions:Set(color)
                currentColor = color
                pickerColorDisplay.BackgroundColor3 = color
                callback(color)
