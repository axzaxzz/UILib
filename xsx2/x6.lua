...
function library:SaveThemeToFile(fileName)
    ...
    if writefile then
        writefile(fileName .. ".json", themeData)
        return true
    end
    return false
end
...
function library:SaveConfig(configName, configData)
    if writefile then
        ...
        writefile(configName .. ".txt", encoded)
        return true
    end
    return false
end
...
function library:LoadConfig(configName)
    if readfile and isfile and isfile(configName .. ".txt") then
        local success, data = pcall(function()
            return game:GetService("HttpService"):JSONDecode(readfile(configName .. ".txt"))
        end)
