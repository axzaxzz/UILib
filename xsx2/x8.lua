    ...
    connection = RunService.RenderStepped:Connect(function()
        ...
        for _, rainData in pairs(rainStreams) do
            if rainData.obj and rainData.obj.Parent then
                ...
                local newY = currentY + rainData.speed
        ...
        for _, streamData in pairs(binaryStreams) do
            if streamData.obj and streamData.obj.Parent then
                ...
                local newY = currentY + streamData.speed
        ...
        for _, particleData in pairs(particles) do
            if particleData.obj and particleData.obj.Parent then
                ...
                local newX = currentX + particleData.speedX
                local newY = currentY + particleData.speedY
                ...
                local newTrans = currentTrans + (particleData.fadeSpeed * particleData.fadeDir)
        ...
        for _, hexData in pairs(hexLines) do
            if hexData.obj and hexData.obj.Parent then
                ...
                local newX = currentX + hexData.speed
                ...
                local newTrans = currentTrans + (hexData.fadeSpeed * hexData.fadeDir)
        ...
        for _, circuitData in pairs(circuitLines) do
            if circuitData.obj and circuitData.obj.Parent then
                ...
                local newTrans = currentTrans + (circuitData.pulseSpeed * circuitData.pulseDir)
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, snow in pairs(snowflakes) do
            if snow.obj and snow.obj.Parent then
                ...
                local newX = currentX + snow.drift
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, petal in pairs(petals) do
            if petal.obj and petal.obj.Parent then
                ...
                local newX = currentX + petal.drift
                local newY = currentY + petal.speed
                ...
                petal.obj.Rotation = petal.obj.Rotation + petal.rotation
            end
        end
    end)
end
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, heart in pairs(hearts) do
            if heart.obj and heart.obj.Parent then
                ...
                local newX = currentX + heart.wobble
                local newY = currentY - heart.speed
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, star in pairs(stars) do
            if star.obj and star.obj.Parent then
                ...
                local newTrans = currentTrans + (star.fadeSpeed * star.fadeDir)
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, bubble in pairs(bubbles) do
            if bubble.obj and bubble.obj.Parent then
                ...
                local newX = currentX + bubble.wobble
                local newY = currentY - bubble.speed
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, leaf in pairs(leaves) do
            if leaf.obj and leaf.obj.Parent then
                ...
                local newX = currentX + leaf.drift
                local newY = currentY + leaf.speed
                ...
                leaf.obj.Rotation = leaf.obj.Rotation + leaf.rotation
            end
        end
    end)
end
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, sparkle in pairs(sparkles) do
            if sparkle.obj and sparkle.obj.Parent then
                ...
                local newTrans = currentTrans + (sparkle.fadeSpeed * sparkle.fadeDir)
...
function library:Introduction()
    ...
    xsxLogo.ImageColor3 = library.theme.accent
    ...
    hashLogo.ImageColor3 = library.theme.accent
    ...
    xsx.TextColor3 = library.theme.textDark
    xsx.TextSize = 10.000
    ...
    text.Text = "hash"
    text.TextColor3 = library.theme.textDark
